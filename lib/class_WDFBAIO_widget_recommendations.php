<?php
class wdfbaio_WidgetRecommendations extends WP_Widget {

	function wdfbaio_WidgetRecommendations () {
		$widget_ops = array('classname' => __CLASS__, 'description' => __('Shows Facebook Recommendations box.', 'wdfbaio'));
	...
	function form($instance) {
		...
		$html .= '<p>';
		$html .= '<label for="' . $this->get_field_id('height') . '">' . __('Height:', 'wdfbaio') . '</label>';
